...
void reader4 (char *msg, int lck)
{
    ...
    assert (ret == DELETED,"Test 4 FAILED here\n");
...
void procC()
{
    ...
    else kprintf("unable to get lock.C \n");
    sleep (2);
...
void procE()
{
    ...
    else kprintf("unable to get lock.E\n");
    sleep (2);
